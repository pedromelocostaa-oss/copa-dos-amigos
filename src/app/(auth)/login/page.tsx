      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md space-y-5">
        ...
        <div className="relative">
          <button
            type="button"
            disabled
            className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 bg-gray-50 rounded-xl py-3.5 text-gray-400 font-semibold min-h-[52px] cursor-not-allowed"
          >
            <svg width="20" height="20" viewBox="0 0 24 24" className="opacity-40">
